...
namespace Doctrine\Bundle\DBALBundle\Controller;
...
class ProfilerController implements ContainerAwareInterface
{
    ...
    public function explainAction($token, $connectionName, $query)
    {
        ...
        $queries = $profile->getCollector('doctrine.dbal')->getQueries();
        ...
        return new Response($this->container->get('twig')->render('@DoctrineDBAL/Collector/explain.html.twig', [
            'data' => $results,
            'query' => $query,
        ]));
    }
